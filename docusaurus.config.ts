...
const config: Config = {
  ...
  projectName: 'ssc-hub', // Usually your repo name.
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        ...
        {href: '/learning', label: 'Learning', position: 'left'},
        {href: '/resources', label: 'Resources', position: 'left'},
        {
          href: 'https://github.com/securesign/ssc-hub',
          label: 'GitHub',
          position: 'right',
        },
      ],
    ...
    footer: {
      ...
      copyright: `Copyright © ${new Date().getFullYear()} SSC Hub`,
    },
    prism: {
